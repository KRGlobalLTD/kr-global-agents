...
export type TaskType = 'accounting' | 'marketing' | 'email' | 'prospecting' | 'onboarding' | 'finance' | 'supervisor' | 'reporting' | 'infrastructure' | 'social' | 'research' | 'support' | 'knowledge' | 'optimization' | 'analytics' | 'maroc' | 'france' | 'pricing' | 'client_success' | 'upsell' | 'saas' | 'ecommerce' | 'immo';
